#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe unig_gui.pyw -i src\unig_scrapper.py -W setup.py
...
unig_gui = Target(
    ...
    script="unig_gui.pyw", # path of the main script

    # Allows to specify the basename of the executable, if different from 'unig_gui'
    # dest_base = "unig_gui",

    # Icon resources:[(resource_id, path to .ico file), ...]
    # icon_resources=[(1, r"unig_gui.ico")]

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="unig_gui", level="asInvoker")).encode("utf-8")),
